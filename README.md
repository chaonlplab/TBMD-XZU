...
This domain-rich composition enhances the dataset’s suitability for **multi-domain ASR**, **speech synthesis**, and **language variation studies** in Tibetan.

| Field        | Duration (hours) | Utterances |
|---------------|----------------:|-----------:|
| News          | 8.55            | 2,999 |
| Novel         | 6.58            | 2,996 |
| Academic      | 5.89            | 3,001 |
